    ...
    function ($rootScope,
        ...
        $scope.getDataEntryForm = function () {
            ...
            angular.forEach($scope.currentStage.programStageSections, function (section) {
                section.open = true;
                // if (section.id == 'j1u6ase0X3G') {
                //     var arr = [];
                //     for (var i = 0, j = 0, len = section.dataElements.length; i < len; i++) {
                //             console.log($scope.currentEvent[section.dataElements[i].id]);
                //     }
                // }
            });
