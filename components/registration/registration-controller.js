...
trackerCapture.controller('RegistrationController',
    function ($rootScope,
        ...
        //For ICMR Leprosy Cascading

        OrganisationUnitService.getLevel2OrganisationUnit().then(function (level2OrgUnit) {
            $scope.stateList = level2OrgUnit.organisationUnits;

            $scope.permanentStateList = level2OrgUnit.organisationUnits;
        });
        ...
        $scope.getDistrict = function (selectedStateUid) {
            ...
            OrganisationUnitService.getChildrenOrganisationUnits(selectedStateUid).then(function (districtOrganisationUnits) {
                $scope.districtList = districtOrganisationUnits.children;
        ...
        $scope.getBlock = function (selectedDistrictUid) {
            $scope.selectedBlockName = null;

            $scope.blockList = [];

            OrganisationUnitService.getChildrenOrganisationUnits(selectedDistrictUid).then(function (blockOrganisationUnits) {
                $scope.blockList = blockOrganisationUnits.children;

                OrganisationUnitService.getOrganisationUnitObject(selectedDistrictUid).then(function (orgUnitDistrictObject) {
                    //$scope.selectedDistrict = orgUnitObject;
        ...
        $scope.getBlockName = function (blockUid) {

            $scope.selectedBlockName = null;
            OrganisationUnitService.getOrganisationUnitObject(blockUid).then(function (orgUnitBlockObject) {
                $scope.selectedBlockName = orgUnitBlockObject.displayName;
            });
        }



        $scope.getPermanentDistrict = function (selectedPermanentStateUid) {
            ...
            OrganisationUnitService.getChildrenOrganisationUnits(selectedPermanentStateUid).then(function (permanentDistrictOrganisationUnits) {
                $scope.permanentDistrictList = permanentDistrictOrganisationUnits.children;

                OrganisationUnitService.getOrganisationUnitObject(selectedPermanentStateUid).then(function (orgUnitPermanentStateObject) {
                    //$scope.selectedDistrict = orgUnitObject;
                    $scope.selectedPermanentStateName = orgUnitPermanentStateObject.displayName;
        ...
        $scope.getPermanentBlock = function (selectedPermanentDistrictUid) {
            $scope.selectedPermanentBlockName = null;

            $scope.permanentBlockList = [];

            OrganisationUnitService.getChildrenOrganisationUnits(selectedPermanentDistrictUid).then(function (permanentBlockOrganisationUnits) {
                $scope.permanentBlockList = permanentBlockOrganisationUnits.children;

                OrganisationUnitService.getOrganisationUnitObject(selectedPermanentDistrictUid).then(function (orgUnitPermanentDistrictObject) {
                    //$scope.selectedDistrict = orgUnitObject;
                    $scope.selectedPermanentDistrictName = orgUnitPermanentDistrictObject.displayName;

                });
            });
        };

        $scope.getPermanentBlockName = function (permanentBlockUid) {

            $scope.selectedPermanentBlockName = null;
            OrganisationUnitService.getOrganisationUnitObject(permanentBlockUid).then(function (orgUnitPermanentBlockObject) {
