/* global trackerCapture, angular */
	...
	trackerCaptureamesNimhans.controller('amesNimhansQueueController', ["$rootScope", "$scope", "$timeout", "$location", "SessionStorageService", "CurrentSelection", function ($rootScope, $scope, $timeout, $location, SessionStorageService, CurrentSelection) {
		...
		$scope.loadQueue2 = function () {
			...
			$.getJSON('../api/sqlViews/Ig7DXsj5Hgk/data.json?var=orgunit:' + ouid2, function (response) {
