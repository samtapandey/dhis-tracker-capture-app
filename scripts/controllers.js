        ...
        $scope.hideRegister = function () {
            if ($scope.selectedOrgUnit != undefined) {
                $.ajax({
                    ...
                    async: false,
                    contentType: "application/json",
                    url: '../api/trackedEntityInstances.json?fields=trackedEntityInstance&filter=' + $scope.userUid + ':EQ:' + $scope.currentUsername + '&ou=' + $scope.selectedOrgUnit.id + '&skipPaging=true',
