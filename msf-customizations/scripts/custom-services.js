    ...
    return {
        ...
        */
        ...
        getLevel3OrganisationUnit: function ( ) {
            var def = $q.defer();
            $http.get('../api/organisationUnits.json?fields=id,name,code&filter=level:eq:3&sortOrder=ASC&paging=false').then(function (response) {
